...
! function() {
    ...
    const Jn = (e, t, n) => {
        ...
        qn = async e => {
            try {
                ...
                let [n, r] = Xn(e), a = Kn(n), o = (await Promise.all(a.map(e => (async (e, t = "ja") => {
                    await xn(), await kn;
                    const n = await Sn("https://api.interpreter.caiyunai.com/v1/page/translator", {
                        cors: !0,
                        method: "POST",
                        headers: {
                            "X-Authorization": "token " + re.data.cyweb_token,
    ...
    const Ai = async () => {
            ...
            if (x.dev && r.includes("/assets/json/") && Ko("STORY", "#ad37c2", e, n), r.includes("/produce_events/") || r.includes("/produce_communications/") || r.includes("/produce_communications_promises/") || r.includes("/produce_communication_promise_results/") || r.includes("/game_event_communications/") || r.includes("/special_communications/") || r.includes("/produce_communication_cheers/") || r.includes("/produce_communication_auditions/") || r.includes("/produce_communication_televisions/")) try {
                ...
                if ("edit" === x.story && (((e, t) => {
                        ...
                        if (!je) {
                            ...
                            if (e) je = new Map(JSON.parse(e));
                            else {
                                const e = await oe("/story.json");
                                je = new Map(e), ue("story.json", JSON.stringify(je))
                            }
                        }
                        if (je.has(e)) {
                ...
                } else "on" === x.auto ? await tr(n, e) : await tr(n, e, !1, !0)
            } catch (e) {
                V(e)
            }
            return n
        ...
        e.innerHTML = `\n  @font-face {\n    font-family: "sczh-heiti";\n    src: url("${x.origin}${ki("heiti",t)}");\n  }\n  @font-face {\n    font-family: "sczh-yuanti";\n    src: url("${x.origin}${ki("yuanti",t)}");\n  }\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  `, "yuanti" === x.font1 && Ti(`${x.origin}${ki("yuanti",t)}`), "heiti" === x.font2 && Ti(`${x.origin}${ki("heiti",t)}`), document.head.appendChild(e)
    };
