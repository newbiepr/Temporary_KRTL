...
! function() {
    ...
    const Xe = new Map,
        ...
        Qe = (e, t = []) => {
            let n = e.replace(/\./g, "\\.").replace(/\$num/g, "([+-＋－]?[0-9０-９①-─]{1,10}\\.?[0-9０-９①-─]{0,4}?)").replace(/\$percent/g, "([+-＋－]?[0-9０-９]{1,10}\\.?[0-9０-９]{0,4}?[%％])").replace(/\$unknown/g, "(.+?)").replace(/\$uk/g, "(.+?)");
            return t.forEach(e => {
    ...
    const Si = e => {
            ...
            document.getElementById("ipt-preview-sczh").addEventListener("change", (function() {
                ...
                clearTimeout(r), t.classList.remove("blur")
            });
            const a = () => {
            ...
            t.addEventListener("mouseleave", a), a()
        },
        _i = {
            name: "",
            filename: "",
